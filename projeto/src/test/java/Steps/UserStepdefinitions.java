...
public class UserStepdefinitions {
    ...
    public void pesquisarPorUsuarios() {
        response = usuarioApi.procuraUsuarios();
    ...
    public void pesquisoPeloIdDeUmUsuario() {
        response = usuarioApi.getPorId(idUsario);
    }
    ...
    public void euAlteroUmUsuarioPeloId() {
        response = usuarioApi.alteraUsuario(idUsario);{
        }
    }
    ...
    public void éSolicitadoADeleçãoDeUmUsuarioPeloId() {
        response = usuarioApi.deletaPorId(idUsario);
    }
