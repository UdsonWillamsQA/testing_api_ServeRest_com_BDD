...
import resources.domain.Carrinho;
...
public class CarrinhoStepDefinitions {
    ...
    public CarrinhoStepDefinitions() {
    ...
    public void euEnvieOsDadosParaCadastramentoDeCarrinho() {
        var carrinho1 = Carrinho.builder().idProduto(ProdutoStepDefinitions.id_produto).quantidade(1).build();
